...
class FReciclerViewAdaptadorNombreDescripcion (
    private val contexto: FReciclerView,
    private val lista: ArrayList<BDEntrenador>,
    private val recyclerView: RecyclerView
): RecyclerView.Adapter<FReciclerViewAdaptadorNombreDescripcion.MyViewHolder>(){
    inner class MyViewHolder(view: View) :RecyclerView.ViewHolder(view){
        ...
        init {
            ...
            descripcionTextView = view.findViewById(R.id.txt_descripcion)
            likesTextView = view.findViewById(R.id.txt_likes)
